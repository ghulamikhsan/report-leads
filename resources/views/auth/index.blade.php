                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">Management Detail Laporan Bulan</h2>
                                    @can('user-create')
                                        <button type="button"
                                ...
                                <div class="card-header">
                                    ...
                                    <!--            <select id="bulan" class="form-control filter" wire:model="month">-->
                                    ...
                                    <table id="example2" class="table table-bordered table-hover data-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="8%">Informasi Customer</th>
                                                <th width="5%">QTY</th>
                                                <th>Pesanan</th>
                                                <th>Keterangan</th>
                                                <th>Action</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('description', null, ['placeholder' => 'Keterangan', 'class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
