                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">Management Detail Laporan Per Tahun</h2>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover data-table">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td>{{ $date }}</td>
                                               <td>
                                                <a href="{{ 'detailthn/'.$date }}" data-toggle="tooltip"  data-original-title="Detail" class="detail btn btn-primary btn-sm detailItem"><i class="fas fa-info-circle"></i> Details</a>
                                            </td>
